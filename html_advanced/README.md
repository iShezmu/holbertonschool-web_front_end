    ...
    - inside `main` after Typography `section`
      ...
      - create a new `section`
        ...
        - after the `header`, create a `table`, reproduce in HTML the visual below
          - The `` tags containing `Title, Director, Release Date` should have a `scope` attribute set to `col` The `` tags containing the names of the movies should have a `scope` attribute set to `row`
